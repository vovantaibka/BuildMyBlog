$(function() {
	...
	var modalCreateAndEdit = $("#create-and-edit-audio");
	var modalView = $("#view-audio");
	...
	$("button.create").click(function() {
		...
		// Set title 
		modalCreateAndEdit.find("h5#title-modal-create-edit").text("Create New Audio");		
		modalCreateAndEdit.find("input#button-submit").val("Create Audio");
		...
		var widthImg = $("#create-and-edit-audio").find('img').width();

		$("#create-and-edit-audio .upload-file").find('label input').css('width', '100%')
