$(function() {
	...
	var modalCreateAndEdit = $("#create-and-edit-tag");
	...
	$("button.create").click(function() {
		...
		// Set title 
		modalCreateAndEdit.find("h5#title-modal-create-edit").text("Create New Tag");		
		modalCreateAndEdit.find("input#button-submit").val("Create Tag");
	...
	$("button.edit").click(function() {
		...
		$.get(apiUrl + '/' + currentObject + "/" + objectId).done(function(response) {
			...
			// Set id
			modalCreateAndEdit.find("input[name=tag_id]").val(response.id);

			// Set title 
			modalCreateAndEdit.find("h5#title-modal-create-edit").text("Edit Tag");		
			modalCreateAndEdit.find("input#button-submit").val("Save Tag");
