...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
  ...
  routes: [{ path: '/', component: Home,
    children: [{ path: '', component: Default }, { path: 'foo', component: Foo }, { path: 'bar', component: Bar }, { path: 'baz', name: 'baz', component: Baz }, { path: 'with-params/:id', component: WithParams },
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(14), __webpack_require__(11), __webpack_require__(85).setImmediate))
