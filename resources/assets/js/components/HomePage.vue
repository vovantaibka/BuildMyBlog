		...
		<div id="introduce">
			<b-row no-gutters>
			    <div class="welcome-blog">
			        <img src="/imgs/man-sitting-near-large-body-of-water-under-clear-sky-during-sunset-164293.jpeg" class="img-responsive img-thumbnail"
			            alt="Welcome image">
			    </div>
			</b-row>
		</div>
		...
		<div id="posts">
			<b-row>
				...
				<b-col md="8" class="my-1">
			        <div class="col-md-12 post" v-for="post in posts">
			            <b-col md="6" class="image">
			                <img :src="post.url_image_post">
			            </b-col>
			            <b-col md="6" class="summary">
			                <div class="author">
			                    <div class="avatar">
			                        <a href="#">
			                            <img src="/imgs/Admin.png" class="" alt="Profile Image">
			                        </a>
			                    </div>
			                    <div class="info">
			                        <span class="name">
			                ...
			                <div class="content">
			                    <a :href="post.url_single_post"><h3 class="title">{{ post.title }}</h3></a>
			                    <span class="body" v-html="post.body"></span>
			                </div>
	...
	mounted() {
		...
		.then(function(resp) {
			...
			app.posts.forEach(function(post) {
				post.body = (post.body.length > 150 ? post.body.slice(0, 150).replace(/(<([^>]+)>)/ig,"") + "..." : post.body.replace(/(<([^>]+)>)/ig,""));
			});
