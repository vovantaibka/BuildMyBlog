			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center">
						<button type="button" class="btn btn-light btn-sm" id="<?php echo e($post->id); ?>"  data-toggle="modal" data-target="#view-post">
							<svg class="svg-icon" viewBox="0 0 20 20">
						...
						<button type="button" class="btn btn-light btn-sm" data-toggle="modal" data-target="#edit-post">
							<svg class="svg-icon" viewBox="0 0 20 20">
