<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4" id="audios">
	...
	<div class="table-responsive">
		<table class="table table-striped table-sm">
			...
			<tbody>
				...
				<tr>
					<th><?php echo e($audio->id); ?></th>
					<th><?php echo e($audio->title); ?></th>
					<td>
						<img src="<?php echo e(asset('imgs/' . $audio->image)); ?>">
					</td>
					
					<td><?php echo e(substr($audio->introduce, 0, 50) . (strlen($audio->introduce) > 50 ? "..." : "")); ?></td>
					<td><?php echo e(date('M j, Y H:i', strtotime($audio->created_at))); ?></td>
					<td><?php echo e(date('M j, Y H:i', strtotime($audio->updated_at))); ?></td>
					<td class="text-center">
						<input type="hidden" name="id" value="<?php echo e($audio->id); ?>">
	...
	<div class="modal fade" id="create-and-edit-audio" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<?php echo Form::open(['route' => 'audios.store', 'data-parsley-validate' => '', 'files' => true, 'id' => 'form-audio']); ?>
				...
				<div class="modal-body">
					...
					<div class="form-group upload-file">
						<img src="#">
						<?php echo e(Form::label('audio_image', 'Image Audio:')); ?>

						<?php echo e(Form::file('audio_image', ['class' => ''])); ?>
					...
					<div class="form-group">
						<?php echo e(Form::label('introduce', 'Introduce:')); ?>

						<?php echo e(Form::text('introduce', null, ['class' => 'form-control', 'required' => ''])); ?>
					...
					<div class="form-group">
						...
						<?php echo e(Form::text('link', null, ['class' => 'form-control', 'required' => '', 'data-parsley-type' => 'url', 'maxlength' => '255'])); ?>
				...
				<div class="modal-footer">
					<div class="form-group">
						...
						<?php echo e(Form::submit('Create Audio', ['class' => 'btn btn-primary', 'id' => 'button-submit'])); ?>
	...
	<script src="<?php echo e(asset('js/admin/crud-audio.js')); ?>"></script>
