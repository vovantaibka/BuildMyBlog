<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4" id="categories">
	<input id="current-object" type="hidden" name="current object" value="category">
		...
		<table class="table table-striped table-sm">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center"><?php echo e($category->posts()->count()); ?></td>
	...
	<div class="modal fade" id="create-and-edit-category" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<div class="form-group">
						...
						<?php echo e(Form::submit('Create New Category', ['class' => 'btn btn-primary', 'id' => 'button-submit'])); ?>
	...
	<script src="<?php echo e(asset('js/admin/crud-category.js')); ?>"></script>
</main>
