        ...
        <ul class="nav navbar-nav navbar-right">
            <?php if(Auth::check()): ?>
                <li class="dropdown">
                    ...
                    aria-expanded="false">Hello <?php echo e(Auth::user()->name); ?>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu">
                        ...
                        <li>
                            <router-link class="" to="/profile-user/<?php echo e(Auth::user()->id); ?>">Account Info</router-link>
                        </li>
                        <li>
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="login">
                        ...
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                <div class="col-md-12">
                                    <input id="login-email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" required autofocus>
